                    ...
                    <div className="carousel-item active  settle">
                        ...
                        <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div className="p-3">
                                ...
                                <a href='#searching' className="btn btn-primary py-md-3 px-md-5 animated slideInRight">Book A Hotel</a>
                    ...
                    <div className="carousel-item settle">
                        ...
                        <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div className="p-3">
                                ...
                                <a href="#searching" className="btn btn-primary py-md-3 px-md-5 animated slideInRight">Book A Room</a>
                            </div>
                        </div>
                    </div>
                    <div className="carousel-item settle">
