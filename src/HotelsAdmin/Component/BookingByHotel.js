...
const BookingByHotel = () => {
    ...
    const handleBook = async () => {
        try {
            const res = await axios.get(`http://localhost:5000/api/booking/hotels/66d20c755261d78d4c94e236`);
            setBooking(res.data)
    ...
    console.log("Booking by hotels ", booking)
    // console.log("Booking by hotels data ",data)
